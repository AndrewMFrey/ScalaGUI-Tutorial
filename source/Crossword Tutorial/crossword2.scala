...
class Solver {
  private val allWords = scala.io.Source.fromFile("wordsEn.txt").getLines().toSet
  private val scrabble = (scala.io.Source.fromFile("scrabble.txt").getLines().toSet
